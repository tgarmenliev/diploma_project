...
Важно е да се отбележи, че този сървърен софтуер е отговорен за търсенето на информация **само за услугите, предлагани от Български Държавни Железници (БДЖ)**! Езиците, на които може да бъде търсена информация за момента са **български и английски** език!
...
Технологиите, използвани за разработката на този сървърен софтуер са:
 * **JavaScript** - програмният език, на който е разработен софтуерът;
 * **Node.js** - позволява използването на JavaScript за създаване на сървърни приложения;
 * **Express.js** - уеб фреймуърк за Node.js. Той улеснява създаването на уеб приложения и API чрез предоставяне на удобен начин за обработка на заявки и управление на маршрути;
